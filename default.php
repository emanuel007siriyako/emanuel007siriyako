...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($is_empty) {
        ...
        $admin_password = md5($_POST['password']);  // Plain text password
        ...
        $login_password = md5($_POST['password']);  // Plain text password
...
<div class="login-container" id="loginContainer">
    <?php if ($is_empty): ?>
        ...
        <form action="" method="post">
            ...
            <a href="default.php" class="btn btn-info" style="text-decoration: none; padding: 10px 20px; display: inline-flex; align-items: center;">
    Login &nbsp;<i class="fas fa-arrow-right" style="margin-right: 8px;"></i> 
</a>
